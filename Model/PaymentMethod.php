...
class PaymentMethod extends \Magento\Payment\Model\Method\AbstractMethod implements GatewayInterface
{
    ...
    public function authorize(\Magento\Payment\Model\InfoInterface $payment, $amount)
    {
        ...
        $response = $ClientPaycomet->CreatePreauthorization($IdUser, $TokenUser, $amount, $realOrderId, $currencyCode,"","",null,$merchantData,null);
    ...
    public function capture(\Magento\Payment\Model\InfoInterface $payment, $amount)
    {
        ...
        switch ($TransactionType){
            ...
            default: // EXECUTE_PURCHASE
                ...
                $response = $ClientPaycomet->ExecutePurchase($IdUser,$TokenUser,$amount,$realOrderId,$currencyCode,"","",null,$merchantData,null);
